...
pages = {
    "New Requests": [
        st.Page("pages/req_promos.py", title="🔥 Promotions"),
        st.Page("pages/req_devices.py", title="📱 Devices"),
    ],
    "Monitor": [
        st.Page("pages/live_promos.py", title="🔴 Promos Live Now"),
        st.Page("pages/rewards_search.py", title="🏆 Rewards Search"),
    ],
    "Workload": [
        st.Page("pages/workload_info.py", title="📄 Details")
    ],
    "Tools": [
        st.Page("pages/linkcraft.py", title="🛠️ LinkCraft Pro"),
        st.Page("pages/console_search.py", title="🖥️ Console Search")
    ]
}
